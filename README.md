...
Reorder Omarchy workspaces by swapping their windows. Hyprland cannot renumber workspaces, and the built-in `omarchy.workspaces` widget stays numeric 1–10 — this plugin exchanges the mapped, non-pinned windows (and your labels) between two ids instead.
...
- **Up / down / drag** — swap that workspace's windows *and* label with the neighbor. Workspace numbers stay 1–10.
